...
export function ThemeSelector({ open = false, onOpenChange }: ThemeSelectorProps) {
  ...
  return (
    <>
      ...
      />
      {/* Panel */}
      <div className="bg-card fixed right-4 top-4 z-50 max-h-[90vh] overflow-y-auto rounded-lg border p-4 shadow-lg">
        <div className="mb-3">
          <h3 className="text-sm font-semibold">Seleccionar tema</h3>
          <p className="text-muted-foreground text-xs">Cambiar tema de color</p>
        </div>
