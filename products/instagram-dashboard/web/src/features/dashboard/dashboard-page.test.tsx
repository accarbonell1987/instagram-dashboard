...
vi.mock('@/features/dashboard/hooks/use-instagram-dashboard', () => ({
...
vi.mock('@/features/agent/hooks/use-growth-agent', () => ({
...
import { DashboardInstagramPage } from './dashboard-page';
