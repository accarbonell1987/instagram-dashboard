...
import { FloatingAgent } from '@/features/agent/components/floating-agent';
import type { ActiveTab } from '@/features/agent/components/floating-agent';
import { useGrowthAgent } from '@/features/agent/hooks/use-growth-agent';
import { ContentIntelligenceSection } from '@/features/dashboard/components/content-intelligence-section';
import { DemographicsSection } from '@/features/dashboard/components/demographics-section';
import { GrowthChart } from '@/features/dashboard/components/growth-chart';
import { MediaDetailPanel } from '@/features/dashboard/components/media-detail-panel';
import { NorthStarScorecards } from '@/features/dashboard/components/north-star-scorecards';
import { PublicationsList } from '@/features/dashboard/components/publications-list';
import {
  ...
  usePublications,
  useDemographics,
} from '@/features/dashboard/hooks/use-instagram-dashboard';
import { ScorecardsSkeleton, PublicationsListSkeleton } from '@/features/shared/components/loading-skeleton';
import { SectionHeader } from '@/features/shared/components/section-header';
import { useHubToken } from '@/features/shared/lib/use-hub-token';
import { getMyModules } from '@/features/shared/services/instagram-api';
