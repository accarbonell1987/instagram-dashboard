...
import { FalAiImageProvider } from './agent/lib/image/fal-ai-image-provider.js';
import { createAgentRoutes } from './agent/routes/agent/agent.routes.js';
import { createCarouselRoutes } from './agent/routes/carousels/carousels.routes.js';
import { createChatRoutes } from './agent/routes/chat/chat.routes.js';
import { createSuggestionsRoutes } from './agent/routes/suggestions/suggestions.routes.js';
import { CarouselService } from './agent/services/carousel.service.js';
import { GrowthAgentService } from './agent/services/growth-agent.service.js';
import { LlmResolver } from './agent/services/llm-resolver.service.js';
import { ScriptGeneratorService } from './agent/services/script-generator.service.js';
import { SuggestionService } from './agent/services/suggestion.service.js';
import { UsageTracker } from './agent/services/usage-tracker.service.js';
import { config } from './config.js';
import { createDashboardRoutes } from './dashboard/routes/dashboard/dashboard.routes.js';
import { createMediaRoutes } from './dashboard/routes/media/media.routes.js';
import { DashboardService } from './dashboard/services/dashboard.service.js';
import { InsightService } from './dashboard/services/insight.service.js';
import { ConflictError } from './errors.js';
import { authGuard } from './middleware/auth-guard.js';
import { errorHandler } from './middleware/error-handler.js';
import { ownerOf } from './shared/domain/owner.js';
import { createRepositories } from './shared/lib/create-repositories.js';
import { createHealthRoutes } from './shared/routes/health/health.routes.js';
import { createInternalRoutes } from './shared/routes/internal/internal.routes.js';
