...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        'border-input relative flex h-9 w-9 items-center justify-center border-y border-r',
        'shadow-xs text-sm outline-none transition-all',
        'first:rounded-l-md first:border-l last:rounded-r-md',
        'aria-invalid:border-destructive',
        'data-[active=true]:border-ring data-[active=true]:z-10',
        'data-[active=true]:ring-ring/50 data-[active=true]:ring-[3px]',
