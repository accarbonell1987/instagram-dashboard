...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        // Hardcoded bg instead of bg-popover: Radix Portals mount on document.body,
        // outside any .theme-* scoped element. CSS custom properties (--popover) don't
        // resolve there. Using explicit colors matches shadcn/ui's official approach.
